...
const TotalOrdersGraph = ({ widgetData,marketPlaceId, DateStartDate, DateEndDate }) => {
    ...
    <Card sx={{ mb: 2, width: '101%', maxWidth: 1500, position: 'relative', marginLeft: '-10px', minHeight: 300, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <CardContent sx={{ flexGrow: 1 }}>
            ...
            <Typography variant="h4" align="right" fontWeight="bold" sx={{ fontSize: '18px', marginBottom: 1 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div ref={chartContainerRef} style={{ width: 'calc(100% - 100px)', scrollBehavior: 'smooth' }}>
                    {salesData.length > 0 ? (
...
/>
    ...
    />
                        ...
                        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: 225, width: "100%" }}>
                            <Typography
                                variant="body2"
                                sx={{
                                    textAlign: "center",
